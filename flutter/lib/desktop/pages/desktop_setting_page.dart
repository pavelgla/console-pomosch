        ...
        child: _Card(title: translate('About RustDesk'), children: [
          Column(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://helpdesk.console10.ru/privacy');
                  },
                  child: Text(
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://helpdesk.console10.ru');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Copyright © ${DateTime.now().toString().substring(0, 4)} ООО «Консоль».\n$license',
